...
> No experimento de 2 semanas o objetivo **não é concluir as 1.000+ horas estimadas**, e sim executar o máximo de WPs com LLM e **medir** o quanto cada uma rendeu por hora real, com que qualidade e com quanta intervenção humana — extrapolando o ganho frente ao baseline.
...
- **Controles de validade:** repositório **congelado** (commit/tag fixo) e **export RTDB fixo** antes da Semana 2; mesmo enunciado de WP para todas as condições; suíte de testes "golden" e rubrica SSQM definidas **antes** de qualquer execução (evita ajuste pós-hoc).
...
Dimensões SSQM que a migração deve elevar diretamente: **SO** (operacional 1/10), **SD** (dados 2/10), **SE** (ecossistema 3/10), **SA** (arquitetural 4/10). A LLM reaplica o checklist em WP-10 e o *delta* é a medida de eficácia de mais alto nível — e o melhor argumento do experimento.
